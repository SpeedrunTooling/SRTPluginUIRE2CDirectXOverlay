...
{
    public class SRTPluginUIRE2CDirectXOverlay : PluginBase, IPluginUI
    {
        internal static PluginInfo _Info = new PluginInfo();
        public override IPluginInfo Info => _Info;
        public string RequiredProvider => "SRTPluginProviderRE2C";
        private IPluginHostDelegates hostDelegates;
        private IGameMemoryRE2C gameMemory;
        ...
        private Process GetProcess() => Process.GetProcessesByName("bio2")?.FirstOrDefault();
        ...
        {
            this.gameMemory = (IGameMemoryRE2C)gameMemory;
        ...
        private void DrawOverlay()
        {
            ...
            foreach (NPCInfo enemy in gameMemory.EnemyHealth.Where(a => a.IsAlive && a.IsBoss).OrderBy(a => a.Percentage).ThenByDescending(a => a.CurrentHP))
                if (config.ShowHPBars)
                {
